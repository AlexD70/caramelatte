...
public class TestRedFar extends LinearOpMode {
    ...
    public void buildTrajectories(int caz){
        ...
        if(caz == 1){
            ...
            preloadAndCollect = bot.drive.trajectorySequenceBuilder(new Pose2d(62,-34,Math.toRadians(0)))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(37,-33, Math.toRadians(150)),Math.toRadians(180))
            ...
            preloadAndCollect = bot.drive.trajectorySequenceBuilder(new Pose2d(62, -34, Math.toRadians(0)))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(38, -50.5, Math.toRadians(150)),Math.toRadians(180))

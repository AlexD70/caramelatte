...
public class NewRobotAutoActions {
...
//                randCase = bot.husky.getCaseRedFar(bot.telemetry);
    ...
    public static void placePixelsOnBackdrop(double timeout, boolean twoPixels) throws InterruptedException{
        ...
        bot.right_armservo.setArmTarget(NEWArm.NewArmPositions.PLACE);
        timer.reset();
    ...
    public static void endAutonomy(double timeout1, double timeout2){
        bot.s_angleAdjust_broom.broomToAngle(NewIntake.AngleAdjustStates_BROOM.NEUTRAL);
        bot.left_armservo.setArmTarget(0);
        bot.right_armservo.setArmTarget(0);
